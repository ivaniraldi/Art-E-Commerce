      ...
      >
        <div className="box-border w-full text-white border-solid md:w-1/2 md:pl-6 xl:pl-20">
          ...
          <p className="pt-4 pb-8 m-0 leading-7 text-white-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">
            ...
            1958.
            <br></br> 
            En 1980 Toma clases de pintura con Carlos Monzani en los
            “Patios de San Telmo” Clases de miniatura y micro miniaturas con
            Morra <br/>En 1982 Viaja a Uruguay, Brasil, costa de Buenos Aires y San
            Pedro a realizar exposiciones de sus Oleos y Miniaturas.
            <br/>
            En 1986
            Expone en Casa do Desenho, Florianópolis, Brasil.
            <br/> En 1989 Primer
            ...
            decreto Nº 1387/89. 
            <br/>En 1996 Pinta un mural de 1,60 x 2 metros
